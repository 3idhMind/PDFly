                ...
                <Card className="p-8 h-full border-2 border-primary relative overflow-hidden glass premium-card">
                  ...
                  <ul className="space-y-3 mb-8">
                    {[
                      ...
                      "Batch generation (up to 5 docs per API call)",
                      "Merge, Split, Compress & PDF to Images APIs",
                      "Browser-only processing for all web tools",
                      "Opt-in zero-retention cloud fallback",
                      "Adaptive compression with target size control",
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      ["15 Templates", "✓", "✓"],
                      ["REST API", "✓", "✓"],
                      ["Batch Generation", "Up to 5", "Up to 50"],
                      ["API Rate Limit", "60/min", "500/min"],
                      ["PDF Password Protection", "—", "✓"],
                      ["Custom Watermarks", "—", "✓"],
                      ["PDF Merge", "✓", "✓"],
                      ["PDF Compression", "✓", "✓"],
                      ["PDF Split & PDF to Images", "✓", "✓"],
                      ["Webhooks", "—", "✓"],
                      ["White-label", "—", "✓"],
                      ["Team Accounts", "—", "✓"],
                      ["Custom Fonts", "—", "✓"],
